package com.javatask.vilniusweather.utils;
...
public class TemperatureDeserializer extends StdDeserializer<Temperature> {
	...
	public Temperature deserialize(JsonParser parser, DeserializationContext ctxt)
		...
		LocalDateTime observationTime = LocalDateTime
				.parse(jsonNode.get("observation_time").get("value").asText().substring(0, 19));
		// Add 3 hours because of different timezone
		observationTime = observationTime.plusHours(3);
